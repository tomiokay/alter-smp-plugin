...
public enum LegendaryType {
    BLADE_OF_FRACTURED_STARS("blade_of_the_fractured_stars", "Holy Moonlight Sword", Material.NETHERITE_SWORD),
    EMBERHEART_SCYTHE("emberheart_scythe", "Pheonix Grace", Material.NETHERITE_SWORD),
    TEMPESTBREAKER_SPEAR("tempestbreaker_spear", "Tempestbreaker Spear", Material.TRIDENT),
    UMBRA_VEIL_DAGGER("umbra_veil_dagger", "Thousand Demon Daggers", Material.NETHERITE_SWORD),
    HEARTROOT_GUARDIAN_AXE("heartroot_guardian_axe", "Divine Axe Rhitta", Material.NETHERITE_AXE),
    ...
    CHRONO_EDGE("chrono_edge", "Chrono Blade", Material.NETHERITE_SWORD),
    OBLIVION_HARVESTER("oblivion_harvester", "Soul Devourer", Material.NETHERITE_SWORD),
    ECLIPSE_DEVOURER("eclipse_devourer", "Creation Splitter", Material.NETHERITE_SWORD),
