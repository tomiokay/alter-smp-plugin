...
public enum LegendaryType {
    HOLY_MOONLIGHT_SWORD("holy_moonlight_sword", "Holy Moonlight Sword", Material.NETHERITE_SWORD),
    PHEONIX_GRACE("pheonix_grace", "Pheonix Grace", Material.NETHERITE_SWORD),
    TEMPESTBREAKER_SPEAR("tempestbreaker_spear", "Tempestbreaker Spear", Material.TRIDENT),
    THOUSAND_DEMON_DAGGERS("thousand_demon_daggers", "Thousand Demon Daggers", Material.NETHERITE_SWORD),
    DIVINE_AXE_RHITTA("divine_axe_rhitta", "Divine Axe Rhitta", Material.NETHERITE_AXE),
    ...
    CHRONO_BLADE("chrono_blade", "Chrono Blade", Material.NETHERITE_SWORD),
    SOUL_DEVOURER("soul_devourer", "Soul Devourer", Material.NETHERITE_SWORD),
    CREATION_SPLITTER("creation_splitter", "Creation Splitter", Material.NETHERITE_SWORD),
